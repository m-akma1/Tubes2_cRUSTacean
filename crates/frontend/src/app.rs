...
use crate::components::tree_input::TreeSelectorStage;
        ...
        <div class="min-h-screen text-slate-900 font-sans">
            <header class="border-b border-brand-sky/30 bg-white/65 backdrop-blur
                ...
                <span class="text-xl font-bold tracking-tight">
                    <span class="text-brand-teal">"cRUST"</span>
                ...
                <div class="ml-auto flex items-center gap-2 text-xs text-slate-600">
                    <StepBadge label="1. HTML"    active=move || ctx.stage.get() == AppStage::HtmlInput />
                    <span class="text-brand-sky/40">"›"</span>
                    <StepBadge label="2. Query"   active=move || ctx.stage.get() == AppStage::TreeSelector />
                    <span class="text-brand-sky/40">"›"</span>
                    <StepBadge label="3. Results" active=move || ctx.stage.get() == AppStage::Results />
                </div>
            </header>
